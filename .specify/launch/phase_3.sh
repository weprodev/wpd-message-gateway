signal_file='/Users/michael/Sites/WeProDev/wpd-message-gateway/.specify/signals/tasks.ready'; printf '\033[33m⏳ Waiting for Master Agent (tasks step) to complete (tasks.ready)...\033[0m\n'; while [[ ! -f "$signal_file" ]]; do sleep 3; done; tmux resize-pane -t "$TMUX_PANE" -y 999 2>/dev/null || true; tmux select-pane -t "$TMUX_PANE" 2>/dev/null || true; printf '\033[32m✅ Signal received: tasks\033[0m\n\n' &&   while true; do
    ...
    # ──────────────────────────────────────────────────────────────────────────
    printf '\033[36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m\n' && printf ' \033[1mRole: backend-engineer  |  Tool: cursor  |  Model: claude-opus\033[0m\n' && printf '\033[36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m\n'
    printf "\n\033[33m⚠️  You have selected Cursor IDE as the agent tool.\033[0m\n" && printf "Please use the Cursor Composer/Chat to complete this phase manually.\n" && echo "$(cat '/Users/michael/Sites/WeProDev/wpd-message-gateway/scripts/roles/backend-engineer.md')

IMPORTANT PIPELINE DIRECTIVE:
You are assigned to Phase: Implement.
...
OUTPUT FILE — you MUST write your artifact to this exact path:
  /Users/michael/Sites/WeProDev/wpd-message-gateway/specs/017-refactor-readmefile-technical-writer/impl.md
...
HOW TO WRITE THE FILE (choose one — DO NOT use subagent tools):
  ...
  Option 2 — use run_shell_command with a heredoc:
    mkdir -p '/Users/michael/Sites/WeProDev/wpd-message-gateway/specs/017-refactor-readmefile-technical-writer' && cat > '/Users/michael/Sites/WeProDev/wpd-message-gateway/specs/017-refactor-readmefile-technical-writer/impl.md' << 'PLAN_EOF'
...
CONTEXT — read the following upstream artifact before starting:
  /Users/michael/Sites/WeProDev/wpd-message-gateway/specs/017-refactor-readmefile-technical-writer/tasks.md

Complete your phase tasks as thoroughly as possible. When you finish, exit immediately." | pbcopy 2>/dev/null || true && printf "\033[32mThe prompt has been copied to your clipboard! Paste it into Cursor.\033[0m\n" && cursor "/Users/michael/Sites/WeProDev/wpd-message-gateway" 2>/dev/null || true
    ...
    target_file="$feature_dir/impl.md"
    ...
    if [[ "impl" == "spec" || "impl" == "plan" || "impl" == "tasks" || "impl" == "impl" || "impl" == "review" ]]; then
    ...
    if [[ "$decision" == "Approve" ]]; then
      touch "/Users/michael/Sites/WeProDev/wpd-message-gateway/.specify/signals/impl.ready"
      ...
      tmux send-keys -t "wpd-gateway:0.0" "I have rejected the Implement phase. Please ask me what needs changing, update the file, and then execute precisely this command in your shell tool to resume the pipeline: touch /Users/michael/Sites/WeProDev/wpd-message-gateway/.specify/signals/impl.revision.ready" Enter
      
      while [[ ! -f "/Users/michael/Sites/WeProDev/wpd-message-gateway/.specify/signals/impl.revision.ready" ]]; do
        sleep 3
      done
      rm -f "/Users/michael/Sites/WeProDev/wpd-message-gateway/.specify/signals/impl.revision.ready"
    fi
  done
