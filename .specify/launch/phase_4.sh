signal_file='/Users/michael/Sites/WeProDev/wpd-message-gateway/.specify/signals/impl.ready'; printf '\033[33m⏳ Waiting for Master Agent (impl step) to complete (impl.ready)...\033[0m\n'; while [[ ! -f "$signal_file" ]]; do sleep 3; done; tmux resize-pane -t "$TMUX_PANE" -y 999 2>/dev/null || true; tmux select-pane -t "$TMUX_PANE" 2>/dev/null || true; printf '\033[32m✅ Signal received: impl\033[0m\n\n' &&   while true; do
    ...
    # ──────────────────────────────────────────────────────────────────────────
    printf '\033[36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m\n' && printf ' \033[1mRole: qa-engineer  |  Tool: gemini  |  Model: claude-opus\033[0m\n' && printf '\033[36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m\n'
    gemini -m claude-opus -y "$(cat '/Users/michael/Sites/WeProDev/wpd-message-gateway/scripts/roles/qa-engineer.md')

IMPORTANT PIPELINE DIRECTIVE:
You are assigned to Phase: Analyze/QA.
...
OUTPUT FILE — you MUST write your artifact to this exact path:
  /Users/michael/Sites/WeProDev/wpd-message-gateway/specs/017-refactor-readmefile-technical-writer/review.md
...
HOW TO WRITE THE FILE (choose one — DO NOT use subagent tools):
  ...
  Option 2 — use run_shell_command with a heredoc:
    mkdir -p '/Users/michael/Sites/WeProDev/wpd-message-gateway/specs/017-refactor-readmefile-technical-writer' && cat > '/Users/michael/Sites/WeProDev/wpd-message-gateway/specs/017-refactor-readmefile-technical-writer/review.md' << 'PLAN_EOF'
...
Complete your phase tasks as thoroughly as possible. When you finish, exit immediately." < /dev/null
    ...
    target_file="$feature_dir/review.md"
    ...
    if [[ "review" == "spec" || "review" == "plan" || "review" == "tasks" || "review" == "impl" || "review" == "review" ]]; then
    ...
    if [[ "$decision" == "Approve" ]]; then
      touch "/Users/michael/Sites/WeProDev/wpd-message-gateway/.specify/signals/review.ready"
      ...
      tmux send-keys -t "wpd-gateway:0.0" "I have rejected the Analyze/QA phase. Please ask me what needs changing, update the file, and then execute precisely this command in your shell tool to resume the pipeline: touch /Users/michael/Sites/WeProDev/wpd-message-gateway/.specify/signals/review.revision.ready" Enter
      
      while [[ ! -f "/Users/michael/Sites/WeProDev/wpd-message-gateway/.specify/signals/review.revision.ready" ]]; do
        sleep 3
      done
      rm -f "/Users/michael/Sites/WeProDev/wpd-message-gateway/.specify/signals/review.revision.ready"
    fi
  done
